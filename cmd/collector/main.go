...
func main() {
	var (
		...
		dynamicAllowlistHost     = flag.String("dynamic-allowlist-host", "", "Host:port for dynamic allowlist source; if empty, dynamic allowlist syncing is disabled")
	...
	cfg := collector.Config{
		...
		PolicyRules:              *policy,
		DynamicAllowlistHost:     *dynamicAllowlistHost,
